...
func NewCoreWebView2Frame(aBaseIntf ICoreWebView2Frame) ICoreWebView2Frame {
	r1 := coreWebView2FrameImportAPI().SysCallN(2, GetObjectUintptr(aBaseIntf))
	return AsCoreWebView2Frame(r1)
}

func (m *TCoreWebView2Frame) Initialized() bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(5, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) BaseIntf() ICoreWebView2Frame {
	var resultCoreWebView2Frame uintptr
	coreWebView2FrameImportAPI().SysCallN(1, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Frame)))
	return AsCoreWebView2Frame(resultCoreWebView2Frame)
}

func (m *TCoreWebView2Frame) FrameID() uint32 {
	r1 := coreWebView2FrameImportAPI().SysCallN(4, m.Instance())
	return uint32(r1)
}

func (m *TCoreWebView2Frame) Name() string {
	r1 := coreWebView2FrameImportAPI().SysCallN(7, m.Instance())
	return GoStr(r1)
}

func (m *TCoreWebView2Frame) IsDestroyed() bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(6, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) AddAllBrowserEvents(aBrowserComponent IComponent) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(0, m.Instance(), GetObjectUintptr(aBrowserComponent))
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) RemoveHostObjectFromScript(aName string) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(11, m.Instance(), PascalStr(aName))
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) ExecuteScript(JavaScript string, aExecutionID int32, aBrowserComponent IComponent) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(3, m.Instance(), PascalStr(JavaScript), uintptr(aExecutionID), GetObjectUintptr(aBrowserComponent))
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) PostWebMessageAsJson(aWebMessageAsJson string) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(9, m.Instance(), PascalStr(aWebMessageAsJson))
	return GoBool(r1)
}

func (m *TCoreWebView2Frame) PostWebMessageAsString(aWebMessageAsString string) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(10, m.Instance(), PascalStr(aWebMessageAsString))
	return GoBool(r1)
}
...
func (m *TCoreWebView2Frame) PostSharedBufferToScript(aSharedBuffer ICoreWebView2SharedBuffer, aAccess TWVSharedBufferAccess, aAdditionalDataAsJson string) bool {
	r1 := coreWebView2FrameImportAPI().SysCallN(8, m.Instance(), GetObjectUintptr(aSharedBuffer), uintptr(aAccess), PascalStr(aAdditionalDataAsJson))
	return GoBool(r1)
}

var (
	coreWebView2FrameImport       *imports.Imports = nil
	coreWebView2FrameImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2Frame_AddAllBrowserEvents", 0),
		/*1*/ imports.NewTable("CoreWebView2Frame_BaseIntf", 0),
		/*2*/ imports.NewTable("CoreWebView2Frame_Create", 0),
		/*3*/ imports.NewTable("CoreWebView2Frame_ExecuteScript", 0),
		/*4*/ imports.NewTable("CoreWebView2Frame_FrameID", 0),
		/*5*/ imports.NewTable("CoreWebView2Frame_Initialized", 0),
		/*6*/ imports.NewTable("CoreWebView2Frame_IsDestroyed", 0),
		/*7*/ imports.NewTable("CoreWebView2Frame_Name", 0),
		/*8*/ imports.NewTable("CoreWebView2Frame_PostSharedBufferToScript", 0),
		/*9*/ imports.NewTable("CoreWebView2Frame_PostWebMessageAsJson", 0),
		/*10*/ imports.NewTable("CoreWebView2Frame_PostWebMessageAsString", 0),
		/*11*/ imports.NewTable("CoreWebView2Frame_RemoveHostObjectFromScript", 0),
	}
)

func coreWebView2FrameImportAPI() *imports.Imports {
	if coreWebView2FrameImport == nil {
		coreWebView2FrameImport = NewDefaultImports()
		coreWebView2FrameImport.SetImportTable(coreWebView2FrameImportTables)
		coreWebView2FrameImportTables = nil
	}
