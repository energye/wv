...
func NewCoreWebView2AcceleratorKeyPressedEventArgs(aArgs ICoreWebView2AcceleratorKeyPressedEventArgs) ICoreWebView2AcceleratorKeyPressedEventArgs {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(1, GetObjectUintptr(aArgs))
...
func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) Initialized() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(3, m.Instance())
	return GoBool(r1)
}
...
func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) BaseIntf() ICoreWebView2AcceleratorKeyPressedEventArgs {
	...
	coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(0, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2AcceleratorKeyPressedEventArgs)))
...
func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) KeyEventKind() TWVKeyEventKind {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(8, m.Instance())
	return TWVKeyEventKind(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) VirtualKey() uint32 {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(12, m.Instance())
	return uint32(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) KeyEventLParam() int32 {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(9, m.Instance())
	return int32(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) RepeatCount() uint32 {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(10, m.Instance())
	return uint32(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) ScanCode() uint32 {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(11, m.Instance())
	return uint32(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) IsExtendedKey() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(5, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) IsMenuKeyDown() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(7, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) WasKeyDown() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(13, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) IsKeyReleased() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(6, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) Handled() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(2, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) SetHandled(AValue bool) {
	coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(2, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) IsBrowserAcceleratorKeyEnabled() bool {
	r1 := coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(4, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2AcceleratorKeyPressedEventArgs) SetIsBrowserAcceleratorKeyEnabled(AValue bool) {
	coreWebView2AcceleratorKeyPressedEventArgsImportAPI().SysCallN(4, 1, m.Instance(), PascalBool(AValue))
}

var (
	coreWebView2AcceleratorKeyPressedEventArgsImport       *imports.Imports = nil
	coreWebView2AcceleratorKeyPressedEventArgsImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_BaseIntf", 0),
		/*1*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_Create", 0),
		/*2*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_Handled", 0),
		/*3*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_Initialized", 0),
		/*4*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_IsBrowserAcceleratorKeyEnabled", 0),
		/*5*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_IsExtendedKey", 0),
		/*6*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_IsKeyReleased", 0),
		/*7*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_IsMenuKeyDown", 0),
		/*8*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_KeyEventKind", 0),
		/*9*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_KeyEventLParam", 0),
		/*10*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_RepeatCount", 0),
		/*11*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_ScanCode", 0),
		/*12*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_VirtualKey", 0),
		/*13*/ imports.NewTable("CoreWebView2AcceleratorKeyPressedEventArgs_WasKeyDown", 0),
	}
)

func coreWebView2AcceleratorKeyPressedEventArgsImportAPI() *imports.Imports {
	if coreWebView2AcceleratorKeyPressedEventArgsImport == nil {
		coreWebView2AcceleratorKeyPressedEventArgsImport = NewDefaultImports()
		coreWebView2AcceleratorKeyPressedEventArgsImport.SetImportTable(coreWebView2AcceleratorKeyPressedEventArgsImportTables)
		coreWebView2AcceleratorKeyPressedEventArgsImportTables = nil
	}
