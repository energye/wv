...
func NewCoreWebView2CompositionController(aBaseIntf ICoreWebView2CompositionController) ICoreWebView2CompositionController {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(3, GetObjectUintptr(aBaseIntf))
	return AsCoreWebView2CompositionController(r1)
}

func (m *TCoreWebView2CompositionController) Initialized() bool {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(9, m.Instance())
	return GoBool(r1)
}
...
func (m *TCoreWebView2CompositionController) BaseIntf() ICoreWebView2CompositionController {
	...
	coreWebView2CompositionControllerImportAPI().SysCallN(2, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2CompositionController)))
...
func (m *TCoreWebView2CompositionController) RootVisualTarget() IUnknown {
	...
	coreWebView2CompositionControllerImportAPI().SysCallN(10, 0, m.Instance(), 0, uintptr(unsafePointer(&resultUnknown)))
	return AsUnknown(resultUnknown)
}

func (m *TCoreWebView2CompositionController) SetRootVisualTarget(AValue IUnknown) {
	coreWebView2CompositionControllerImportAPI().SysCallN(10, 1, m.Instance(), GetObjectUintptr(AValue), GetObjectUintptr(AValue))
}

func (m *TCoreWebView2CompositionController) Cursor() HCURSOR {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(4, m.Instance())
	return HCURSOR(r1)
}

func (m *TCoreWebView2CompositionController) SystemCursorID() uint32 {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(13, m.Instance())
	return uint32(r1)
}

func (m *TCoreWebView2CompositionController) AutomationProvider() IUnknown {
	var resultUnknown uintptr
	coreWebView2CompositionControllerImportAPI().SysCallN(1, m.Instance(), uintptr(unsafePointer(&resultUnknown)))
	return AsUnknown(resultUnknown)
}

func (m *TCoreWebView2CompositionController) AddAllBrowserEvents(aBrowserComponent IComponent) bool {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(0, m.Instance(), GetObjectUintptr(aBrowserComponent))
	return GoBool(r1)
}
...
func (m *TCoreWebView2CompositionController) SendMouseInput(aEventKind TWVMouseEventKind, aVirtualKeys TWVMouseEventVirtualKeys, aMouseData uint32, aPoint *TPoint) bool {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(11, m.Instance(), uintptr(aEventKind), uintptr(aVirtualKeys), uintptr(aMouseData), uintptr(unsafePointer(aPoint)))
	return GoBool(r1)
}
...
func (m *TCoreWebView2CompositionController) SendPointerInput(aEventKind TWVPointerEventKind, aPointerInfo ICoreWebView2PointerInfo) bool {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(12, m.Instance(), uintptr(aEventKind), GetObjectUintptr(aPointerInfo))
	return GoBool(r1)
}
...
func (m *TCoreWebView2CompositionController) DragEnter(dataObject IDataObject, keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result3 uintptr
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(5, m.Instance(), GetObjectUintptr(dataObject), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result3)))
	*OutEffect = uint32(result3)
	return int32(r1)
}

func (m *TCoreWebView2CompositionController) DragLeave() int32 {
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(6, m.Instance())
	return int32(r1)
}

func (m *TCoreWebView2CompositionController) DragOver(keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result2 uintptr
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(7, m.Instance(), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result2)))
...
func (m *TCoreWebView2CompositionController) Drop(dataObject IDataObject, keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result3 uintptr
	r1 := coreWebView2CompositionControllerImportAPI().SysCallN(8, m.Instance(), GetObjectUintptr(dataObject), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result3)))
	*OutEffect = uint32(result3)
	return int32(r1)
}
...
var (
	...
	coreWebView2CompositionControllerImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2CompositionController_AddAllBrowserEvents", 0),
		/*1*/ imports.NewTable("CoreWebView2CompositionController_AutomationProvider", 0),
		/*2*/ imports.NewTable("CoreWebView2CompositionController_BaseIntf", 0),
		/*3*/ imports.NewTable("CoreWebView2CompositionController_Create", 0),
		/*4*/ imports.NewTable("CoreWebView2CompositionController_Cursor", 0),
		/*5*/ imports.NewTable("CoreWebView2CompositionController_DragEnter", 0),
		/*6*/ imports.NewTable("CoreWebView2CompositionController_DragLeave", 0),
		/*7*/ imports.NewTable("CoreWebView2CompositionController_DragOver", 0),
		/*8*/ imports.NewTable("CoreWebView2CompositionController_Drop", 0),
		/*9*/ imports.NewTable("CoreWebView2CompositionController_Initialized", 0),
		/*10*/ imports.NewTable("CoreWebView2CompositionController_RootVisualTarget", 0),
		/*11*/ imports.NewTable("CoreWebView2CompositionController_SendMouseInput", 0),
		/*12*/ imports.NewTable("CoreWebView2CompositionController_SendPointerInput", 0),
		/*13*/ imports.NewTable("CoreWebView2CompositionController_SystemCursorID", 0),
	}
)

func coreWebView2CompositionControllerImportAPI() *imports.Imports {
	if coreWebView2CompositionControllerImport == nil {
		coreWebView2CompositionControllerImport = NewDefaultImports()
		coreWebView2CompositionControllerImport.SetImportTable(coreWebView2CompositionControllerImportTables)
		coreWebView2CompositionControllerImportTables = nil
	}
