...
func NewCoreWebView2Controller(aBaseIntf ICoreWebView2Controller) ICoreWebView2Controller {
	r1 := coreWebView2ControllerImportAPI().SysCallN(7, GetObjectUintptr(aBaseIntf))
	return AsCoreWebView2Controller(r1)
}

func (m *TCoreWebView2Controller) Initialized() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(9, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) BaseIntf() ICoreWebView2Controller {
	var resultCoreWebView2Controller uintptr
	coreWebView2ControllerImportAPI().SysCallN(2, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Controller)))
...
func (m *TCoreWebView2Controller) ZoomFactor() (resultDouble float64) {
	coreWebView2ControllerImportAPI().SysCallN(17, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TCoreWebView2Controller) SetZoomFactor(AValue float64) {
	coreWebView2ControllerImportAPI().SysCallN(17, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TCoreWebView2Controller) IsVisible() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(10, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) SetIsVisible(AValue bool) {
	coreWebView2ControllerImportAPI().SysCallN(10, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Controller) Bounds() (resultRect TRect) {
	coreWebView2ControllerImportAPI().SysCallN(3, 0, m.Instance(), uintptr(unsafePointer(&resultRect)), uintptr(unsafePointer(&resultRect)))
	return
}

func (m *TCoreWebView2Controller) SetBounds(AValue *TRect) {
	coreWebView2ControllerImportAPI().SysCallN(3, 1, m.Instance(), uintptr(unsafePointer(AValue)), uintptr(unsafePointer(AValue)))
}

func (m *TCoreWebView2Controller) ParentWindow() THandle {
	r1 := coreWebView2ControllerImportAPI().SysCallN(13, 0, m.Instance(), 0)
	return THandle(r1)
}

func (m *TCoreWebView2Controller) SetParentWindow(AValue THandle) {
	coreWebView2ControllerImportAPI().SysCallN(13, 1, m.Instance(), uintptr(AValue))
}

func (m *TCoreWebView2Controller) DefaultBackgroundColor() TColor {
	r1 := coreWebView2ControllerImportAPI().SysCallN(8, 0, m.Instance(), 0)
	return TColor(r1)
}

func (m *TCoreWebView2Controller) SetDefaultBackgroundColor(AValue TColor) {
	coreWebView2ControllerImportAPI().SysCallN(8, 1, m.Instance(), uintptr(AValue))
}

func (m *TCoreWebView2Controller) RasterizationScale() (resultDouble float64) {
	coreWebView2ControllerImportAPI().SysCallN(14, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TCoreWebView2Controller) SetRasterizationScale(AValue float64) {
	coreWebView2ControllerImportAPI().SysCallN(14, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TCoreWebView2Controller) ShouldDetectMonitorScaleChanges() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(16, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) SetShouldDetectMonitorScaleChanges(AValue bool) {
	coreWebView2ControllerImportAPI().SysCallN(16, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Controller) BoundsMode() TWVBoundsMode {
	r1 := coreWebView2ControllerImportAPI().SysCallN(4, 0, m.Instance(), 0)
	return TWVBoundsMode(r1)
}

func (m *TCoreWebView2Controller) SetBoundsMode(AValue TWVBoundsMode) {
	coreWebView2ControllerImportAPI().SysCallN(4, 1, m.Instance(), uintptr(AValue))
}

func (m *TCoreWebView2Controller) CoreWebView2() ICoreWebView2 {
	var resultCoreWebView2 uintptr
	coreWebView2ControllerImportAPI().SysCallN(6, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2)))
	return AsCoreWebView2(resultCoreWebView2)
}

func (m *TCoreWebView2Controller) AllowExternalDrop() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(1, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) SetAllowExternalDrop(AValue bool) {
	coreWebView2ControllerImportAPI().SysCallN(1, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Controller) AddAllBrowserEvents(aBrowserComponent IComponent) bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(0, m.Instance(), GetObjectUintptr(aBrowserComponent))
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) MoveFocus(aReason TWVMoveFocusReason) bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(11, m.Instance(), uintptr(aReason))
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) Close() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(5, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) SetBoundsAndZoomFactor(aBounds *TRect, aZoomFactor float64) bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(15, m.Instance(), uintptr(unsafePointer(aBounds)), uintptr(unsafePointer(&aZoomFactor)))
	return GoBool(r1)
}

func (m *TCoreWebView2Controller) NotifyParentWindowPositionChanged() bool {
	r1 := coreWebView2ControllerImportAPI().SysCallN(12, m.Instance())
	return GoBool(r1)
}

var (
	coreWebView2ControllerImport       *imports.Imports = nil
	coreWebView2ControllerImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2Controller_AddAllBrowserEvents", 0),
		/*1*/ imports.NewTable("CoreWebView2Controller_AllowExternalDrop", 0),
		/*2*/ imports.NewTable("CoreWebView2Controller_BaseIntf", 0),
		/*3*/ imports.NewTable("CoreWebView2Controller_Bounds", 0),
		/*4*/ imports.NewTable("CoreWebView2Controller_BoundsMode", 0),
		/*5*/ imports.NewTable("CoreWebView2Controller_Close", 0),
		/*6*/ imports.NewTable("CoreWebView2Controller_CoreWebView2", 0),
		/*7*/ imports.NewTable("CoreWebView2Controller_Create", 0),
		/*8*/ imports.NewTable("CoreWebView2Controller_DefaultBackgroundColor", 0),
		/*9*/ imports.NewTable("CoreWebView2Controller_Initialized", 0),
		/*10*/ imports.NewTable("CoreWebView2Controller_IsVisible", 0),
		/*11*/ imports.NewTable("CoreWebView2Controller_MoveFocus", 0),
		/*12*/ imports.NewTable("CoreWebView2Controller_NotifyParentWindowPositionChanged", 0),
		/*13*/ imports.NewTable("CoreWebView2Controller_ParentWindow", 0),
		/*14*/ imports.NewTable("CoreWebView2Controller_RasterizationScale", 0),
		/*15*/ imports.NewTable("CoreWebView2Controller_SetBoundsAndZoomFactor", 0),
		/*16*/ imports.NewTable("CoreWebView2Controller_ShouldDetectMonitorScaleChanges", 0),
		/*17*/ imports.NewTable("CoreWebView2Controller_ZoomFactor", 0),
	}
)

func coreWebView2ControllerImportAPI() *imports.Imports {
	if coreWebView2ControllerImport == nil {
		coreWebView2ControllerImport = NewDefaultImports()
		coreWebView2ControllerImport.SetImportTable(coreWebView2ControllerImportTables)
		coreWebView2ControllerImportTables = nil
	}
