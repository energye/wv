...
type IWVBrowserBase interface {
	...
	ScreenScale() (resultSingle float32) // property
	// Offline
	...
	ClearBrowsingDataInTimeRange(dataKinds TWVBrowsingDataKinds, startTime, endTime float64) bool // function
...
func (m *TWVBrowserBase) Initialized() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(85, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) CoreWebView2PrintSettings() ICoreWebView2PrintSettings {
	var resultCoreWebView2PrintSettings uintptr
	wVBrowserBaseImportAPI().SysCallN(37, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2PrintSettings)))
...
func (m *TWVBrowserBase) CoreWebView2Settings() ICoreWebView2Settings {
	...
	wVBrowserBaseImportAPI().SysCallN(38, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Settings)))
...
func (m *TWVBrowserBase) CoreWebView2Environment() ICoreWebView2Environment {
	...
	wVBrowserBaseImportAPI().SysCallN(36, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Environment)))
...
func (m *TWVBrowserBase) CoreWebView2Controller() ICoreWebView2Controller {
	...
	wVBrowserBaseImportAPI().SysCallN(35, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Controller)))
...
func (m *TWVBrowserBase) CoreWebView2CompositionController() ICoreWebView2CompositionController {
	...
	wVBrowserBaseImportAPI().SysCallN(34, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2CompositionController)))
...
func (m *TWVBrowserBase) CoreWebView2() ICoreWebView2 {
	...
	wVBrowserBaseImportAPI().SysCallN(33, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2)))
...
func (m *TWVBrowserBase) Profile() ICoreWebView2Profile {
	...
	wVBrowserBaseImportAPI().SysCallN(122, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Profile)))
	return AsCoreWebView2Profile(resultCoreWebView2Profile)
}

func (m *TWVBrowserBase) DefaultURL() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(55, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetDefaultURL(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(55, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) IsNavigating() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(91, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ZoomPct() (resultDouble float64) {
	wVBrowserBaseImportAPI().SysCallN(267, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TWVBrowserBase) SetZoomPct(AValue float64) {
	wVBrowserBaseImportAPI().SysCallN(267, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TWVBrowserBase) ZoomStep() byte {
	r1 := wVBrowserBaseImportAPI().SysCallN(268, 0, m.Instance(), 0)
	return byte(r1)
}

func (m *TWVBrowserBase) SetZoomStep(AValue byte) {
	wVBrowserBaseImportAPI().SysCallN(268, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) Widget0CompHWND() THandle {
	r1 := wVBrowserBaseImportAPI().SysCallN(263, m.Instance())
	return THandle(r1)
}

func (m *TWVBrowserBase) Widget1CompHWND() THandle {
	r1 := wVBrowserBaseImportAPI().SysCallN(264, m.Instance())
	return THandle(r1)
}

func (m *TWVBrowserBase) RenderCompHWND() THandle {
	r1 := wVBrowserBaseImportAPI().SysCallN(134, m.Instance())
	return THandle(r1)
}

func (m *TWVBrowserBase) D3DWindowCompHWND() THandle {
	r1 := wVBrowserBaseImportAPI().SysCallN(47, m.Instance())
	return THandle(r1)
}

func (m *TWVBrowserBase) ScreenScale() (resultSingle float32) {
	r1 := wVBrowserBaseImportAPI().SysCallN(143, m.Instance())
	return float32(r1)
}

func (m *TWVBrowserBase) Offline() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(108, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetOffline(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(108, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) IgnoreCertificateErrors() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(83, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIgnoreCertificateErrors(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(83, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) BrowserExecPath() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(13, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetBrowserExecPath(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(13, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) UserDataFolder() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(261, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetUserDataFolder(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(261, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) AdditionalBrowserArguments() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(4, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetAdditionalBrowserArguments(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(4, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) Language() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(100, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetLanguage(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(100, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) TargetCompatibleBrowserVersion() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(257, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetTargetCompatibleBrowserVersion(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(257, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) AllowSingleSignOnUsingOSPrimaryAccount() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(6, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetAllowSingleSignOnUsingOSPrimaryAccount(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(6, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ExclusiveUserDataFolderAccess() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(68, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetExclusiveUserDataFolderAccess(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(68, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) CustomCrashReportingEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(46, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetCustomCrashReportingEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(46, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) EnableTrackingPrevention() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(67, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetEnableTrackingPrevention(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(67, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) AreBrowserExtensionsEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(8, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetAreBrowserExtensionsEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(8, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) BrowserVersionInfo() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(15, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) BrowserProcessID() uint32 {
	r1 := wVBrowserBaseImportAPI().SysCallN(14, m.Instance())
	return uint32(r1)
}

func (m *TWVBrowserBase) CanGoBack() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(19, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) CanGoForward() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(20, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ContainsFullScreenElement() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(30, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) DocumentTitle() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(62, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) Source() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(251, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) CookieManager() ICoreWebView2CookieManager {
	var resultCoreWebView2CookieManager uintptr
	wVBrowserBaseImportAPI().SysCallN(31, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2CookieManager)))
	return AsCoreWebView2CookieManager(resultCoreWebView2CookieManager)
}

func (m *TWVBrowserBase) IsSuspended() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(95, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) IsDocumentPlayingAudio() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(87, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) IsMuted() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(90, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsMuted(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(90, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) DefaultDownloadDialogCornerAlignment() TWVDefaultDownloadDialogCornerAlignment {
	r1 := wVBrowserBaseImportAPI().SysCallN(51, 0, m.Instance(), 0)
...
func (m *TWVBrowserBase) SetDefaultDownloadDialogCornerAlignment(AValue TWVDefaultDownloadDialogCornerAlignment) {
	wVBrowserBaseImportAPI().SysCallN(51, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) DefaultDownloadDialogMargin() (resultPoint TPoint) {
	wVBrowserBaseImportAPI().SysCallN(52, 0, m.Instance(), uintptr(unsafePointer(&resultPoint)), uintptr(unsafePointer(&resultPoint)))
	return
}

func (m *TWVBrowserBase) SetDefaultDownloadDialogMargin(AValue *TPoint) {
	wVBrowserBaseImportAPI().SysCallN(52, 1, m.Instance(), uintptr(unsafePointer(AValue)), uintptr(unsafePointer(AValue)))
}

func (m *TWVBrowserBase) IsDefaultDownloadDialogOpen() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(86, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) StatusBarText() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(253, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) FaviconURI() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(71, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) MemoryUsageTargetLevel() TWVMemoryUsageTargetLevel {
	r1 := wVBrowserBaseImportAPI().SysCallN(101, 0, m.Instance(), 0)
	return TWVMemoryUsageTargetLevel(r1)
}

func (m *TWVBrowserBase) SetMemoryUsageTargetLevel(AValue TWVMemoryUsageTargetLevel) {
	wVBrowserBaseImportAPI().SysCallN(101, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) Bounds() (resultRect TRect) {
	wVBrowserBaseImportAPI().SysCallN(11, 0, m.Instance(), uintptr(unsafePointer(&resultRect)), uintptr(unsafePointer(&resultRect)))
	return
}

func (m *TWVBrowserBase) SetBounds(AValue *TRect) {
	wVBrowserBaseImportAPI().SysCallN(11, 1, m.Instance(), uintptr(unsafePointer(AValue)), uintptr(unsafePointer(AValue)))
}

func (m *TWVBrowserBase) IsVisible() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(97, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsVisible(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(97, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ParentWindow() THandle {
	r1 := wVBrowserBaseImportAPI().SysCallN(112, 0, m.Instance(), 0)
	return THandle(r1)
}

func (m *TWVBrowserBase) SetParentWindow(AValue THandle) {
	wVBrowserBaseImportAPI().SysCallN(112, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) ZoomFactor() (resultDouble float64) {
	wVBrowserBaseImportAPI().SysCallN(266, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TWVBrowserBase) SetZoomFactor(AValue float64) {
	wVBrowserBaseImportAPI().SysCallN(266, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TWVBrowserBase) DefaultBackgroundColor() TColor {
	r1 := wVBrowserBaseImportAPI().SysCallN(49, 0, m.Instance(), 0)
	return TColor(r1)
}

func (m *TWVBrowserBase) SetDefaultBackgroundColor(AValue TColor) {
	wVBrowserBaseImportAPI().SysCallN(49, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) BoundsMode() TWVBoundsMode {
	r1 := wVBrowserBaseImportAPI().SysCallN(12, 0, m.Instance(), 0)
	return TWVBoundsMode(r1)
}

func (m *TWVBrowserBase) SetBoundsMode(AValue TWVBoundsMode) {
	wVBrowserBaseImportAPI().SysCallN(12, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) RasterizationScale() (resultDouble float64) {
	wVBrowserBaseImportAPI().SysCallN(128, 0, m.Instance(), uintptr(unsafePointer(&resultDouble)), uintptr(unsafePointer(&resultDouble)))
	return
}

func (m *TWVBrowserBase) SetRasterizationScale(AValue float64) {
	wVBrowserBaseImportAPI().SysCallN(128, 1, m.Instance(), uintptr(unsafePointer(&AValue)), uintptr(unsafePointer(&AValue)))
}

func (m *TWVBrowserBase) ShouldDetectMonitorScaleChanges() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(247, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetShouldDetectMonitorScaleChanges(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(247, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) AllowExternalDrop() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(5, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetAllowExternalDrop(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(5, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) DefaultContextMenusEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(50, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetDefaultContextMenusEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(50, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) DefaultScriptDialogsEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(54, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetDefaultScriptDialogsEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(54, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) DevToolsEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(61, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetDevToolsEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(61, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) AreHostObjectsAllowed() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(9, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetAreHostObjectsAllowed(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(9, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) BuiltInErrorPageEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(16, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetBuiltInErrorPageEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(16, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ScriptEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(144, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetScriptEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(144, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) StatusBarEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(252, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetStatusBarEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(252, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) WebMessageEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(262, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetWebMessageEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(262, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ZoomControlEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(265, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetZoomControlEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(265, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) UserAgent() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(260, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetUserAgent(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(260, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) AreBrowserAcceleratorKeysEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(7, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetAreBrowserAcceleratorKeysEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(7, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) IsGeneralAutofillEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(88, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsGeneralAutofillEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(88, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) IsPasswordAutosaveEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(92, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsPasswordAutosaveEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(92, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) IsPinchZoomEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(93, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsPinchZoomEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(93, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) IsSwipeNavigationEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(96, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsSwipeNavigationEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(96, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) HiddenPdfToolbarItems() TWVPDFToolbarItems {
	r1 := wVBrowserBaseImportAPI().SysCallN(82, 0, m.Instance(), 0)
	return TWVPDFToolbarItems(r1)
}

func (m *TWVBrowserBase) SetHiddenPdfToolbarItems(AValue TWVPDFToolbarItems) {
	wVBrowserBaseImportAPI().SysCallN(82, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) IsReputationCheckingRequired() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(94, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsReputationCheckingRequired(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(94, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) Cursor() HCURSOR {
	r1 := wVBrowserBaseImportAPI().SysCallN(45, m.Instance())
	return HCURSOR(r1)
}

func (m *TWVBrowserBase) RootVisualTarget() IUnknown {
	var resultUnknown uintptr
	wVBrowserBaseImportAPI().SysCallN(142, 0, m.Instance(), 0, uintptr(unsafePointer(&resultUnknown)))
	return AsUnknown(resultUnknown)
}

func (m *TWVBrowserBase) SetRootVisualTarget(AValue IUnknown) {
	wVBrowserBaseImportAPI().SysCallN(142, 1, m.Instance(), GetObjectUintptr(AValue), GetObjectUintptr(AValue))
}

func (m *TWVBrowserBase) SystemCursorID() uint32 {
	r1 := wVBrowserBaseImportAPI().SysCallN(256, m.Instance())
	return uint32(r1)
}

func (m *TWVBrowserBase) AutomationProvider() IUnknown {
	var resultUnknown uintptr
	wVBrowserBaseImportAPI().SysCallN(10, m.Instance(), uintptr(unsafePointer(&resultUnknown)))
	return AsUnknown(resultUnknown)
}

func (m *TWVBrowserBase) ProcessInfos() ICoreWebView2ProcessInfoCollection {
	var resultCoreWebView2ProcessInfoCollection uintptr
	wVBrowserBaseImportAPI().SysCallN(121, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2ProcessInfoCollection)))
...
func (m *TWVBrowserBase) ProfileName() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(126, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetProfileName(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(126, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) IsInPrivateModeEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(89, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetIsInPrivateModeEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(89, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ScriptLocale() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(145, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetScriptLocale(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(145, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) ProfilePath() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(127, m.Instance())
	return GoStr(r1)
}

func (m *TWVBrowserBase) DefaultDownloadFolderPath() string {
	r1 := wVBrowserBaseImportAPI().SysCallN(53, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TWVBrowserBase) SetDefaultDownloadFolderPath(AValue string) {
	wVBrowserBaseImportAPI().SysCallN(53, 1, m.Instance(), PascalStr(AValue))
}

func (m *TWVBrowserBase) PreferredColorScheme() TWVPreferredColorScheme {
	r1 := wVBrowserBaseImportAPI().SysCallN(116, 0, m.Instance(), 0)
	return TWVPreferredColorScheme(r1)
}

func (m *TWVBrowserBase) SetPreferredColorScheme(AValue TWVPreferredColorScheme) {
	wVBrowserBaseImportAPI().SysCallN(116, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) PreferredTrackingPreventionLevel() TWVTrackingPreventionLevel {
	r1 := wVBrowserBaseImportAPI().SysCallN(117, 0, m.Instance(), 0)
...
func (m *TWVBrowserBase) SetPreferredTrackingPreventionLevel(AValue TWVTrackingPreventionLevel) {
	wVBrowserBaseImportAPI().SysCallN(117, 1, m.Instance(), uintptr(AValue))
}

func (m *TWVBrowserBase) ProfileCookieManager() ICoreWebView2CookieManager {
	var resultCoreWebView2CookieManager uintptr
	wVBrowserBaseImportAPI().SysCallN(123, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2CookieManager)))
	return AsCoreWebView2CookieManager(resultCoreWebView2CookieManager)
}

func (m *TWVBrowserBase) ProfileIsPasswordAutosaveEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(125, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetProfileIsPasswordAutosaveEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(125, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) ProfileIsGeneralAutofillEnabled() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(124, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetProfileIsGeneralAutofillEnabled(AValue bool) {
	wVBrowserBaseImportAPI().SysCallN(124, 1, m.Instance(), PascalBool(AValue))
}

func (m *TWVBrowserBase) FrameId() uint32 {
	r1 := wVBrowserBaseImportAPI().SysCallN(74, m.Instance())
	return uint32(r1)
}

func (m *TWVBrowserBase) CreateBrowser(aHandle THandle, aUseDefaultEnvironment bool) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(39, m.Instance(), uintptr(aHandle), PascalBool(aUseDefaultEnvironment))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CreateBrowser1(aHandle THandle, aEnvironment ICoreWebView2Environment) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(40, m.Instance(), uintptr(aHandle), GetObjectUintptr(aEnvironment))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CreateWindowlessBrowser(aHandle THandle, aUseDefaultEnvironment bool) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(43, m.Instance(), uintptr(aHandle), PascalBool(aUseDefaultEnvironment))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CreateWindowlessBrowser1(aHandle THandle, aEnvironment ICoreWebView2Environment) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(44, m.Instance(), uintptr(aHandle), GetObjectUintptr(aEnvironment))
	return GoBool(r1)
}

func (m *TWVBrowserBase) GoBack() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(80, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) GoForward() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(81, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) Refresh() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(129, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) RefreshIgnoreCache() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(130, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) Stop() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(254, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) Navigate(aURI string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(104, m.Instance(), PascalStr(aURI))
	return GoBool(r1)
}

func (m *TWVBrowserBase) NavigateToString(aHTMLContent string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(105, m.Instance(), PascalStr(aHTMLContent))
	return GoBool(r1)
}

func (m *TWVBrowserBase) NavigateWithWebResourceRequest(aRequest ICoreWebView2WebResourceRequestRef) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(106, m.Instance(), GetObjectUintptr(aRequest))
	return GoBool(r1)
}

func (m *TWVBrowserBase) SubscribeToDevToolsProtocolEvent(aEventName string, aEventID int32) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(255, m.Instance(), PascalStr(aEventName), uintptr(aEventID))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CallDevToolsProtocolMethod(aMethodName, aParametersAsJson string, aExecutionID int32) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(17, m.Instance(), PascalStr(aMethodName), PascalStr(aParametersAsJson), uintptr(aExecutionID))
	return GoBool(r1)
}
...
func (m *TWVBrowserBase) CallDevToolsProtocolMethodForSession(aSessionId, aMethodName, aParametersAsJson string, aExecutionID int32) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(18, m.Instance(), PascalStr(aSessionId), PascalStr(aMethodName), PascalStr(aParametersAsJson), uintptr(aExecutionID))
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetFocus() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(149, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) FocusNext() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(72, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) FocusPrevious() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(73, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ExecuteScriptWithResult(aJavaScript string, aExecutionID int32) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(70, m.Instance(), PascalStr(aJavaScript), uintptr(aExecutionID))
	return GoBool(r1)
}

func (m *TWVBrowserBase) ExecuteScript(aJavaScript string, aExecutionID int32) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(69, m.Instance(), PascalStr(aJavaScript), uintptr(aExecutionID))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CapturePreview(aImageFormat TWVCapturePreviewImageFormat, aImageStream IStream) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(21, m.Instance(), uintptr(aImageFormat), GetObjectUintptr(aImageStream))
	return GoBool(r1)
}

func (m *TWVBrowserBase) NotifyParentWindowPositionChanged() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(107, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetPermissionState(aPermissionKind TWVPermissionKind, aOrigin string, aState TWVPermissionState) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(245, m.Instance(), uintptr(aPermissionKind), PascalStr(aOrigin), uintptr(aState))
	return GoBool(r1)
}

func (m *TWVBrowserBase) GetNonDefaultPermissionSettings() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(78, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) AddBrowserExtension(extensionFolderPath string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(0, m.Instance(), PascalStr(extensionFolderPath))
	return GoBool(r1)
}

func (m *TWVBrowserBase) GetBrowserExtensions() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(75, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) DeleteProfile() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(60, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) TrySuspend() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(259, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) Resume() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(138, m.Instance())
	return GoBool(r1)
}
...
func (m *TWVBrowserBase) SetVirtualHostNameToFolderMapping(aHostName, aFolderPath string, aAccessKind TWVHostResourceAcccessKind) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(246, m.Instance(), PascalStr(aHostName), PascalStr(aFolderPath), uintptr(aAccessKind))
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearVirtualHostNameToFolderMapping(aHostName string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(28, m.Instance(), PascalStr(aHostName))
	return GoBool(r1)
}

func (m *TWVBrowserBase) RetrieveHTML() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(139, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) RetrieveText() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(141, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) RetrieveMHTML() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(140, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) Print() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(118, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ShowPrintUI(aUseSystemPrintDialog bool) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(248, m.Instance(), PascalBool(aUseSystemPrintDialog))
	return GoBool(r1)
}

func (m *TWVBrowserBase) PrintToPdf(aResultFilePath string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(119, m.Instance(), PascalStr(aResultFilePath))
	return GoBool(r1)
}

func (m *TWVBrowserBase) PrintToPdfStream() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(120, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) OpenDevToolsWindow() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(110, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) OpenTaskManagerWindow() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(111, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) PostWebMessageAsJson(aWebMessageAsJson string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(114, m.Instance(), PascalStr(aWebMessageAsJson))
	return GoBool(r1)
}

func (m *TWVBrowserBase) PostWebMessageAsString(aWebMessageAsString string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(115, m.Instance(), PascalStr(aWebMessageAsString))
	return GoBool(r1)
}

func (m *TWVBrowserBase) AddWebResourceRequestedFilter(aURI string, aResourceContext TWVWebResourceContext) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(3, m.Instance(), PascalStr(aURI), uintptr(aResourceContext))
	return GoBool(r1)
}

func (m *TWVBrowserBase) RemoveWebResourceRequestedFilter(aURI string, aResourceContext TWVWebResourceContext) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(133, m.Instance(), PascalStr(aURI), uintptr(aResourceContext))
	return GoBool(r1)
}

func (m *TWVBrowserBase) RemoveHostObjectFromScript(aName string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(131, m.Instance(), PascalStr(aName))
	return GoBool(r1)
}

func (m *TWVBrowserBase) AddScriptToExecuteOnDocumentCreated(JavaScript string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(2, m.Instance(), PascalStr(JavaScript))
	return GoBool(r1)
}

func (m *TWVBrowserBase) RemoveScriptToExecuteOnDocumentCreated(aID string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(132, m.Instance(), PascalStr(aID))
	return GoBool(r1)
}
...
func (m *TWVBrowserBase) CreateCookie(aName, aValue, aDomain, aPath string) ICoreWebView2Cookie {
	...
	wVBrowserBaseImportAPI().SysCallN(41, m.Instance(), PascalStr(aName), PascalStr(aValue), PascalStr(aDomain), PascalStr(aPath), uintptr(unsafePointer(&resultCoreWebView2Cookie)))
...
func (m *TWVBrowserBase) CopyCookie(aCookie ICoreWebView2Cookie) ICoreWebView2Cookie {
	var resultCoreWebView2Cookie uintptr
	wVBrowserBaseImportAPI().SysCallN(32, m.Instance(), GetObjectUintptr(aCookie), uintptr(unsafePointer(&resultCoreWebView2Cookie)))
	return AsCoreWebView2Cookie(resultCoreWebView2Cookie)
}

func (m *TWVBrowserBase) GetCookies(aURI string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(76, m.Instance(), PascalStr(aURI))
	return GoBool(r1)
}

func (m *TWVBrowserBase) AddOrUpdateCookie(aCookie ICoreWebView2Cookie) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(1, m.Instance(), GetObjectUintptr(aCookie))
	return GoBool(r1)
}

func (m *TWVBrowserBase) DeleteCookie(aCookie ICoreWebView2Cookie) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(57, m.Instance(), GetObjectUintptr(aCookie))
	return GoBool(r1)
}

func (m *TWVBrowserBase) DeleteCookies(aName, aURI string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(58, m.Instance(), PascalStr(aName), PascalStr(aURI))
	return GoBool(r1)
}

func (m *TWVBrowserBase) DeleteCookiesWithDomainAndPath(aName, aDomain, aPath string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(59, m.Instance(), PascalStr(aName), PascalStr(aDomain), PascalStr(aPath))
	return GoBool(r1)
}

func (m *TWVBrowserBase) DeleteAllCookies() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(56, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) SetBoundsAndZoomFactor(aBounds *TRect, aZoomFactor float64) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(148, m.Instance(), uintptr(unsafePointer(aBounds)), uintptr(unsafePointer(&aZoomFactor)))
	return GoBool(r1)
}

func (m *TWVBrowserBase) OpenDefaultDownloadDialog() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(109, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) CloseDefaultDownloadDialog() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(29, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) SimulateEditingCommand(aEditingCommand TWV2EditingCommand) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(249, m.Instance(), uintptr(aEditingCommand))
	return GoBool(r1)
}
...
func (m *TWVBrowserBase) SendMouseInput(aEventKind TWVMouseEventKind, aVirtualKeys TWVMouseEventVirtualKeys, aMouseData uint32, aPoint *TPoint) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(146, m.Instance(), uintptr(aEventKind), uintptr(aVirtualKeys), uintptr(aMouseData), uintptr(unsafePointer(aPoint)))
	return GoBool(r1)
}

func (m *TWVBrowserBase) SendPointerInput(aEventKind TWVPointerEventKind, aPointerInfo ICoreWebView2PointerInfo) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(147, m.Instance(), uintptr(aEventKind), GetObjectUintptr(aPointerInfo))
	return GoBool(r1)
}

func (m *TWVBrowserBase) DragEnter(dataObject IDataObject, keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result3 uintptr
	r1 := wVBrowserBaseImportAPI().SysCallN(63, m.Instance(), GetObjectUintptr(dataObject), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result3)))
	*OutEffect = uint32(result3)
	return int32(r1)
}

func (m *TWVBrowserBase) DragLeave() int32 {
	r1 := wVBrowserBaseImportAPI().SysCallN(64, m.Instance())
	return int32(r1)
}

func (m *TWVBrowserBase) DragOver(keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result2 uintptr
	r1 := wVBrowserBaseImportAPI().SysCallN(65, m.Instance(), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result2)))
...
func (m *TWVBrowserBase) Drop(dataObject IDataObject, keyState uint32, point *TPoint, OutEffect *uint32) int32 {
	var result3 uintptr
	r1 := wVBrowserBaseImportAPI().SysCallN(66, m.Instance(), GetObjectUintptr(dataObject), uintptr(keyState), uintptr(unsafePointer(point)), uintptr(unsafePointer(&result3)))
	*OutEffect = uint32(result3)
	return int32(r1)
}

func (m *TWVBrowserBase) ClearCache() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(25, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearDataForOrigin(aOrigin string, aStorageTypes TWVClearDataStorageTypes) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(26, m.Instance(), PascalStr(aOrigin), uintptr(aStorageTypes))
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearBrowsingData(dataKinds TWVBrowsingDataKinds) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(22, m.Instance(), uintptr(dataKinds))
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearBrowsingDataInTimeRange(dataKinds TWVBrowsingDataKinds, startTime, endTime float64) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(24, m.Instance(), uintptr(dataKinds), uintptr(unsafePointer(&startTime)), uintptr(unsafePointer(&endTime)))
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearBrowsingDataAll() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(23, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) ClearServerCertificateErrorActions() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(27, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) GetFavicon(aFormat TWVFaviconImageFormat) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(77, m.Instance(), uintptr(aFormat))
	return GoBool(r1)
}

func (m *TWVBrowserBase) CreateSharedBuffer(aSize int64, aSharedBuffer *ICoreWebView2SharedBuffer) bool {
	var result1 uintptr
	r1 := wVBrowserBaseImportAPI().SysCallN(42, m.Instance(), uintptr(unsafePointer(&aSize)), uintptr(unsafePointer(&result1)))
...
func (m *TWVBrowserBase) PostSharedBufferToScript(aSharedBuffer ICoreWebView2SharedBuffer, aAccess TWVSharedBufferAccess, aAdditionalDataAsJson string) bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(113, m.Instance(), GetObjectUintptr(aSharedBuffer), uintptr(aAccess), PascalStr(aAdditionalDataAsJson))
	return GoBool(r1)
}

func (m *TWVBrowserBase) GetProcessExtendedInfos() bool {
	r1 := wVBrowserBaseImportAPI().SysCallN(79, m.Instance())
	return GoBool(r1)
}

func (m *TWVBrowserBase) MoveFormTo(x, y int32) {
	wVBrowserBaseImportAPI().SysCallN(103, m.Instance(), uintptr(x), uintptr(y))
}

func (m *TWVBrowserBase) MoveFormBy(x, y int32) {
	wVBrowserBaseImportAPI().SysCallN(102, m.Instance(), uintptr(x), uintptr(y))
}

func (m *TWVBrowserBase) ResizeFormWidthTo(x int32) {
	wVBrowserBaseImportAPI().SysCallN(137, m.Instance(), uintptr(x))
}

func (m *TWVBrowserBase) ResizeFormHeightTo(y int32) {
	wVBrowserBaseImportAPI().SysCallN(136, m.Instance(), uintptr(y))
}

func (m *TWVBrowserBase) SetFormLeftTo(x int32) {
	wVBrowserBaseImportAPI().SysCallN(150, m.Instance(), uintptr(x))
}

func (m *TWVBrowserBase) SetFormTopTo(y int32) {
	wVBrowserBaseImportAPI().SysCallN(151, m.Instance(), uintptr(y))
}

func (m *TWVBrowserBase) IncZoomStep() {
	wVBrowserBaseImportAPI().SysCallN(84, m.Instance())
}

func (m *TWVBrowserBase) DecZoomStep() {
	wVBrowserBaseImportAPI().SysCallN(48, m.Instance())
}

func (m *TWVBrowserBase) ResetZoom() {
	wVBrowserBaseImportAPI().SysCallN(135, m.Instance())
}

func (m *TWVBrowserBase) ToggleMuteState() {
	wVBrowserBaseImportAPI().SysCallN(258, m.Instance())
}
...
func (m *TWVBrowserBase) SetOnBrowserProcessExited(fn TOnBrowserProcessExitedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(158, m.Instance(), m.browserProcessExitedPtr)
}
...
func (m *TWVBrowserBase) SetOnProcessInfosChanged(fn TOnProcessInfosChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(219, m.Instance(), m.processInfosChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnContainsFullScreenElementChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(167, m.Instance(), m.containsFullScreenElementChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnContentLoading(fn TOnContentLoadingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(168, m.Instance(), m.contentLoadingPtr)
}
...
func (m *TWVBrowserBase) SetOnDocumentTitleChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(176, m.Instance(), m.documentTitleChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameNavigationCompleted(fn TOnNavigationCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(189, m.Instance(), m.frameNavigationCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameNavigationStarting(fn TOnNavigationStartingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(191, m.Instance(), m.frameNavigationStartingPtr)
}
...
func (m *TWVBrowserBase) SetOnHistoryChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(201, m.Instance(), m.historyChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnNavigationCompleted(fn TOnNavigationCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(210, m.Instance(), m.navigationCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnNavigationStarting(fn TOnNavigationStartingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(211, m.Instance(), m.navigationStartingPtr)
}
...
func (m *TWVBrowserBase) SetOnNewWindowRequested(fn TOnNewWindowRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(212, m.Instance(), m.newWindowRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnPermissionRequested(fn TOnPermissionRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(214, m.Instance(), m.permissionRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnProcessFailed(fn TOnProcessFailedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(218, m.Instance(), m.processFailedPtr)
}
...
func (m *TWVBrowserBase) SetOnScriptDialogOpening(fn TOnScriptDialogOpeningEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(229, m.Instance(), m.scriptDialogOpeningPtr)
}
...
func (m *TWVBrowserBase) SetOnSourceChanged(fn TOnSourceChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(234, m.Instance(), m.sourceChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnWebMessageReceived(fn TOnWebMessageReceivedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(237, m.Instance(), m.webMessageReceivedPtr)
}
...
func (m *TWVBrowserBase) SetOnWebResourceRequested(fn TOnWebResourceRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(238, m.Instance(), m.webResourceRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnWindowCloseRequested(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(243, m.Instance(), m.windowCloseRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnDOMContentLoaded(fn TOnDOMContentLoadedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(174, m.Instance(), m.dOMContentLoadedPtr)
}
...
func (m *TWVBrowserBase) SetOnWebResourceResponseReceived(fn TOnWebResourceResponseReceivedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(239, m.Instance(), m.webResourceResponseReceivedPtr)
}
...
func (m *TWVBrowserBase) SetOnDownloadStarting(fn TOnDownloadStartingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(177, m.Instance(), m.downloadStartingPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameCreated(fn TOnFrameCreatedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(185, m.Instance(), m.frameCreatedPtr)
}
...
func (m *TWVBrowserBase) SetOnClientCertificateRequested(fn TOnClientCertificateRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(165, m.Instance(), m.clientCertificateRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnIsDocumentPlayingAudioChanged(fn TOnIsDocumentPlayingAudioChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(205, m.Instance(), m.isDocumentPlayingAudioChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnIsMutedChanged(fn TOnIsMutedChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(206, m.Instance(), m.isMutedChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnIsDefaultDownloadDialogOpenChanged(fn TOnIsDefaultDownloadDialogOpenChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(204, m.Instance(), m.isDefaultDownloadDialogOpenChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnBasicAuthenticationRequested(fn TOnBasicAuthenticationRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(155, m.Instance(), m.basicAuthenticationRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnContextMenuRequested(fn TOnContextMenuRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(169, m.Instance(), m.contextMenuRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnStatusBarTextChanged(fn TOnStatusBarTextChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(235, m.Instance(), m.statusBarTextChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnServerCertificateErrorActionsCompleted(fn TOnServerCertificateErrorActionsCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(230, m.Instance(), m.serverCertificateErrorActionsCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnServerCertificateErrorDetected(fn TOnServerCertificateErrorDetectedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(231, m.Instance(), m.serverCertificateErrorDetectedPtr)
}
...
func (m *TWVBrowserBase) SetOnFaviconChanged(fn TOnFaviconChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(183, m.Instance(), m.faviconChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnGetFaviconCompleted(fn TOnGetFaviconCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(197, m.Instance(), m.getFaviconCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnPrintCompleted(fn TOnPrintCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(215, m.Instance(), m.printCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnPrintToPdfStreamCompleted(fn TOnPrintToPdfStreamCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(217, m.Instance(), m.printToPdfStreamCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnAcceleratorKeyPressed(fn TOnAcceleratorKeyPressedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(152, m.Instance(), m.acceleratorKeyPressedPtr)
}
...
func (m *TWVBrowserBase) SetOnGotFocus(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(200, m.Instance(), m.gotFocusPtr)
}
...
func (m *TWVBrowserBase) SetOnLostFocus(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(208, m.Instance(), m.lostFocusPtr)
}
...
func (m *TWVBrowserBase) SetOnMoveFocusRequested(fn TOnMoveFocusRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(209, m.Instance(), m.moveFocusRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnZoomFactorChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(244, m.Instance(), m.zoomFactorChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnRasterizationScaleChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(223, m.Instance(), m.rasterizationScaleChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnCursorChanged(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(171, m.Instance(), m.cursorChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnBytesReceivedChanged(fn TOnBytesReceivedChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(159, m.Instance(), m.bytesReceivedChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnEstimatedEndTimeChanged(fn TOnEstimatedEndTimeChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(180, m.Instance(), m.estimatedEndTimeChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnDownloadStateChanged(fn TOnDownloadStateChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(178, m.Instance(), m.downloadStateChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameDestroyed(fn TOnFrameDestroyedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(187, m.Instance(), m.frameDestroyedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameNameChanged(fn TOnFrameNameChangedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(188, m.Instance(), m.frameNameChangedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameNavigationStarting2(fn TOnFrameNavigationStartingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(192, m.Instance(), m.frameNavigationStarting2Ptr)
}
...
func (m *TWVBrowserBase) SetOnFrameNavigationCompleted2(fn TOnFrameNavigationCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(190, m.Instance(), m.frameNavigationCompleted2Ptr)
}
...
func (m *TWVBrowserBase) SetOnFrameContentLoading(fn TOnFrameContentLoadingEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(184, m.Instance(), m.frameContentLoadingPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameDOMContentLoaded(fn TOnFrameDOMContentLoadedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(186, m.Instance(), m.frameDOMContentLoadedPtr)
}
...
func (m *TWVBrowserBase) SetOnFrameWebMessageReceived(fn TOnFrameWebMessageReceivedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(194, m.Instance(), m.frameWebMessageReceivedPtr)
}
...
func (m *TWVBrowserBase) SetOnFramePermissionRequested(fn TOnFramePermissionRequestedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(193, m.Instance(), m.framePermissionRequestedPtr)
}
...
func (m *TWVBrowserBase) SetOnDevToolsProtocolEventReceived(fn TOnDevToolsProtocolEventReceivedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(175, m.Instance(), m.devToolsProtocolEventReceivedPtr)
}
...
func (m *TWVBrowserBase) SetOnCustomItemSelected(fn TOnCustomItemSelectedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(172, m.Instance(), m.customItemSelectedPtr)
}
...
func (m *TWVBrowserBase) SetOnClearBrowsingDataCompleted(fn TOnClearBrowsingDataCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(162, m.Instance(), m.clearBrowsingDataCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnInitializationError(fn TOnInitializationErrorEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(203, m.Instance(), m.initializationErrorPtr)
}
...
func (m *TWVBrowserBase) SetOnEnvironmentCompleted(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(179, m.Instance(), m.environmentCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnControllerCompleted(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(170, m.Instance(), m.controllerCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnAfterCreated(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(154, m.Instance(), m.afterCreatedPtr)
}
...
func (m *TWVBrowserBase) SetOnExecuteScriptCompleted(fn TOnExecuteScriptCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(181, m.Instance(), m.executeScriptCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnCapturePreviewCompleted(fn TOnCapturePreviewCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(161, m.Instance(), m.capturePreviewCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnGetCookiesCompleted(fn TOnGetCookiesCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(195, m.Instance(), m.getCookiesCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnTrySuspendCompleted(fn TOnTrySuspendCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(236, m.Instance(), m.trySuspendCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnPrintToPdfCompleted(fn TOnPrintToPdfCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(216, m.Instance(), m.printToPdfCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnCompositionControllerCompleted(fn TNotifyEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(166, m.Instance(), m.compositionControllerCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnCallDevToolsProtocolMethodCompleted(fn TOnCallDevToolsProtocolMethodCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(160, m.Instance(), m.callDevToolsProtocolMethodCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnAddScriptToExecuteOnDocumentCreatedCompleted(fn TOnAddScriptToExecuteOnDocumentCreatedCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(153, m.Instance(), m.addScriptToExecuteOnDocumentCreatedCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnWebResourceResponseViewGetContentCompleted(fn TOnWebResourceResponseViewGetContentCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(240, m.Instance(), m.webResourceResponseViewGetContentCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnWidget0CompMsg(fn TOnCompMsgEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(241, m.Instance(), m.widget0CompMsgPtr)
}
...
func (m *TWVBrowserBase) SetOnWidget1CompMsg(fn TOnCompMsgEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(242, m.Instance(), m.widget1CompMsgPtr)
}
...
func (m *TWVBrowserBase) SetOnRenderCompMsg(fn TOnCompMsgEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(225, m.Instance(), m.renderCompMsgPtr)
}
...
func (m *TWVBrowserBase) SetOnD3DWindowCompMsg(fn TOnCompMsgEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(173, m.Instance(), m.d3DWindowCompMsgPtr)
}
...
func (m *TWVBrowserBase) SetOnRetrieveHTMLCompleted(fn TOnRetrieveHTMLCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(226, m.Instance(), m.retrieveHTMLCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnRetrieveTextCompleted(fn TOnRetrieveTextCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(228, m.Instance(), m.retrieveTextCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnRetrieveMHTMLCompleted(fn TOnRetrieveMHTMLCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(227, m.Instance(), m.retrieveMHTMLCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnClearCacheCompleted(fn TOnClearCacheCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(163, m.Instance(), m.clearCacheCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnClearDataForOriginCompleted(fn TOnClearDataForOriginCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(164, m.Instance(), m.clearDataForOriginCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnOfflineCompleted(fn TOnOfflineCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(213, m.Instance(), m.offlineCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnIgnoreCertificateErrorsCompleted(fn TOnIgnoreCertificateErrorsCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(202, m.Instance(), m.ignoreCertificateErrorsCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnRefreshIgnoreCacheCompleted(fn TOnRefreshIgnoreCacheCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(224, m.Instance(), m.refreshIgnoreCacheCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnSimulateKeyEventCompleted(fn TOnSimulateKeyEventCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(233, m.Instance(), m.simulateKeyEventCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnGetCustomSchemes(fn TOnGetCustomSchemesEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(196, m.Instance(), m.getCustomSchemesPtr)
}
...
func (m *TWVBrowserBase) SetOnGetNonDefaultPermissionSettingsCompleted(fn TOnGetNonDefaultPermissionSettingsCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(198, m.Instance(), m.getNonDefaultPermissionSettingsCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnSetPermissionStateCompleted(fn TOnSetPermissionStateCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(232, m.Instance(), m.setPermissionStateCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnLaunchingExternalUriScheme(fn TOnLaunchingExternalUriSchemeEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(207, m.Instance(), m.launchingExternalUriSchemePtr)
}
...
func (m *TWVBrowserBase) SetOnGetProcessExtendedInfosCompleted(fn TOnGetProcessExtendedInfosCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(199, m.Instance(), m.getProcessExtendedInfosCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnBrowserExtensionRemoveCompleted(fn TOnBrowserExtensionRemoveCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(157, m.Instance(), m.browserExtensionRemoveCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnBrowserExtensionEnableCompleted(fn TOnBrowserExtensionEnableCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(156, m.Instance(), m.browserExtensionEnableCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnProfileAddBrowserExtensionCompleted(fn TOnProfileAddBrowserExtensionCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(220, m.Instance(), m.profileAddBrowserExtensionCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnProfileGetBrowserExtensionsCompleted(fn TOnProfileGetBrowserExtensionsCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(222, m.Instance(), m.profileGetBrowserExtensionsCompletedPtr)
}
...
func (m *TWVBrowserBase) SetOnProfileDeleted(fn TOnProfileDeletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(221, m.Instance(), m.profileDeletedPtr)
}
...
func (m *TWVBrowserBase) SetOnExecuteScriptWithResultCompleted(fn TOnExecuteScriptWithResultCompletedEvent) {
	...
	wVBrowserBaseImportAPI().SysCallN(182, m.Instance(), m.executeScriptWithResultCompletedPtr)
}

var (
	wVBrowserBaseImport       *imports.Imports = nil
	wVBrowserBaseImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("WVBrowserBase_AddBrowserExtension", 0),
		/*1*/ imports.NewTable("WVBrowserBase_AddOrUpdateCookie", 0),
		/*2*/ imports.NewTable("WVBrowserBase_AddScriptToExecuteOnDocumentCreated", 0),
		/*3*/ imports.NewTable("WVBrowserBase_AddWebResourceRequestedFilter", 0),
		/*4*/ imports.NewTable("WVBrowserBase_AdditionalBrowserArguments", 0),
		/*5*/ imports.NewTable("WVBrowserBase_AllowExternalDrop", 0),
		/*6*/ imports.NewTable("WVBrowserBase_AllowSingleSignOnUsingOSPrimaryAccount", 0),
		/*7*/ imports.NewTable("WVBrowserBase_AreBrowserAcceleratorKeysEnabled", 0),
		/*8*/ imports.NewTable("WVBrowserBase_AreBrowserExtensionsEnabled", 0),
		/*9*/ imports.NewTable("WVBrowserBase_AreHostObjectsAllowed", 0),
		/*10*/ imports.NewTable("WVBrowserBase_AutomationProvider", 0),
		/*11*/ imports.NewTable("WVBrowserBase_Bounds", 0),
		/*12*/ imports.NewTable("WVBrowserBase_BoundsMode", 0),
		/*13*/ imports.NewTable("WVBrowserBase_BrowserExecPath", 0),
		/*14*/ imports.NewTable("WVBrowserBase_BrowserProcessID", 0),
		/*15*/ imports.NewTable("WVBrowserBase_BrowserVersionInfo", 0),
		/*16*/ imports.NewTable("WVBrowserBase_BuiltInErrorPageEnabled", 0),
		/*17*/ imports.NewTable("WVBrowserBase_CallDevToolsProtocolMethod", 0),
		/*18*/ imports.NewTable("WVBrowserBase_CallDevToolsProtocolMethodForSession", 0),
		/*19*/ imports.NewTable("WVBrowserBase_CanGoBack", 0),
		/*20*/ imports.NewTable("WVBrowserBase_CanGoForward", 0),
		/*21*/ imports.NewTable("WVBrowserBase_CapturePreview", 0),
		/*22*/ imports.NewTable("WVBrowserBase_ClearBrowsingData", 0),
		/*23*/ imports.NewTable("WVBrowserBase_ClearBrowsingDataAll", 0),
		/*24*/ imports.NewTable("WVBrowserBase_ClearBrowsingDataInTimeRange", 0),
		/*25*/ imports.NewTable("WVBrowserBase_ClearCache", 0),
		/*26*/ imports.NewTable("WVBrowserBase_ClearDataForOrigin", 0),
		/*27*/ imports.NewTable("WVBrowserBase_ClearServerCertificateErrorActions", 0),
		/*28*/ imports.NewTable("WVBrowserBase_ClearVirtualHostNameToFolderMapping", 0),
		/*29*/ imports.NewTable("WVBrowserBase_CloseDefaultDownloadDialog", 0),
		/*30*/ imports.NewTable("WVBrowserBase_ContainsFullScreenElement", 0),
		/*31*/ imports.NewTable("WVBrowserBase_CookieManager", 0),
		/*32*/ imports.NewTable("WVBrowserBase_CopyCookie", 0),
		/*33*/ imports.NewTable("WVBrowserBase_CoreWebView2", 0),
		/*34*/ imports.NewTable("WVBrowserBase_CoreWebView2CompositionController", 0),
		/*35*/ imports.NewTable("WVBrowserBase_CoreWebView2Controller", 0),
		/*36*/ imports.NewTable("WVBrowserBase_CoreWebView2Environment", 0),
		/*37*/ imports.NewTable("WVBrowserBase_CoreWebView2PrintSettings", 0),
		/*38*/ imports.NewTable("WVBrowserBase_CoreWebView2Settings", 0),
		/*39*/ imports.NewTable("WVBrowserBase_CreateBrowser", 0),
		/*40*/ imports.NewTable("WVBrowserBase_CreateBrowser1", 0),
		/*41*/ imports.NewTable("WVBrowserBase_CreateCookie", 0),
		/*42*/ imports.NewTable("WVBrowserBase_CreateSharedBuffer", 0),
		/*43*/ imports.NewTable("WVBrowserBase_CreateWindowlessBrowser", 0),
		/*44*/ imports.NewTable("WVBrowserBase_CreateWindowlessBrowser1", 0),
		/*45*/ imports.NewTable("WVBrowserBase_Cursor", 0),
		/*46*/ imports.NewTable("WVBrowserBase_CustomCrashReportingEnabled", 0),
		/*47*/ imports.NewTable("WVBrowserBase_D3DWindowCompHWND", 0),
		/*48*/ imports.NewTable("WVBrowserBase_DecZoomStep", 0),
		/*49*/ imports.NewTable("WVBrowserBase_DefaultBackgroundColor", 0),
		/*50*/ imports.NewTable("WVBrowserBase_DefaultContextMenusEnabled", 0),
		/*51*/ imports.NewTable("WVBrowserBase_DefaultDownloadDialogCornerAlignment", 0),
		/*52*/ imports.NewTable("WVBrowserBase_DefaultDownloadDialogMargin", 0),
		/*53*/ imports.NewTable("WVBrowserBase_DefaultDownloadFolderPath", 0),
		/*54*/ imports.NewTable("WVBrowserBase_DefaultScriptDialogsEnabled", 0),
		/*55*/ imports.NewTable("WVBrowserBase_DefaultURL", 0),
		/*56*/ imports.NewTable("WVBrowserBase_DeleteAllCookies", 0),
		/*57*/ imports.NewTable("WVBrowserBase_DeleteCookie", 0),
		/*58*/ imports.NewTable("WVBrowserBase_DeleteCookies", 0),
		/*59*/ imports.NewTable("WVBrowserBase_DeleteCookiesWithDomainAndPath", 0),
		/*60*/ imports.NewTable("WVBrowserBase_DeleteProfile", 0),
		/*61*/ imports.NewTable("WVBrowserBase_DevToolsEnabled", 0),
		/*62*/ imports.NewTable("WVBrowserBase_DocumentTitle", 0),
		/*63*/ imports.NewTable("WVBrowserBase_DragEnter", 0),
		/*64*/ imports.NewTable("WVBrowserBase_DragLeave", 0),
		/*65*/ imports.NewTable("WVBrowserBase_DragOver", 0),
		/*66*/ imports.NewTable("WVBrowserBase_Drop", 0),
		/*67*/ imports.NewTable("WVBrowserBase_EnableTrackingPrevention", 0),
		/*68*/ imports.NewTable("WVBrowserBase_ExclusiveUserDataFolderAccess", 0),
		/*69*/ imports.NewTable("WVBrowserBase_ExecuteScript", 0),
		/*70*/ imports.NewTable("WVBrowserBase_ExecuteScriptWithResult", 0),
		/*71*/ imports.NewTable("WVBrowserBase_FaviconURI", 0),
		/*72*/ imports.NewTable("WVBrowserBase_FocusNext", 0),
		/*73*/ imports.NewTable("WVBrowserBase_FocusPrevious", 0),
		/*74*/ imports.NewTable("WVBrowserBase_FrameId", 0),
		/*75*/ imports.NewTable("WVBrowserBase_GetBrowserExtensions", 0),
		/*76*/ imports.NewTable("WVBrowserBase_GetCookies", 0),
		/*77*/ imports.NewTable("WVBrowserBase_GetFavicon", 0),
		/*78*/ imports.NewTable("WVBrowserBase_GetNonDefaultPermissionSettings", 0),
		/*79*/ imports.NewTable("WVBrowserBase_GetProcessExtendedInfos", 0),
		/*80*/ imports.NewTable("WVBrowserBase_GoBack", 0),
		/*81*/ imports.NewTable("WVBrowserBase_GoForward", 0),
		/*82*/ imports.NewTable("WVBrowserBase_HiddenPdfToolbarItems", 0),
		/*83*/ imports.NewTable("WVBrowserBase_IgnoreCertificateErrors", 0),
		/*84*/ imports.NewTable("WVBrowserBase_IncZoomStep", 0),
		/*85*/ imports.NewTable("WVBrowserBase_Initialized", 0),
		/*86*/ imports.NewTable("WVBrowserBase_IsDefaultDownloadDialogOpen", 0),
		/*87*/ imports.NewTable("WVBrowserBase_IsDocumentPlayingAudio", 0),
		/*88*/ imports.NewTable("WVBrowserBase_IsGeneralAutofillEnabled", 0),
		/*89*/ imports.NewTable("WVBrowserBase_IsInPrivateModeEnabled", 0),
		/*90*/ imports.NewTable("WVBrowserBase_IsMuted", 0),
		/*91*/ imports.NewTable("WVBrowserBase_IsNavigating", 0),
		/*92*/ imports.NewTable("WVBrowserBase_IsPasswordAutosaveEnabled", 0),
		/*93*/ imports.NewTable("WVBrowserBase_IsPinchZoomEnabled", 0),
		/*94*/ imports.NewTable("WVBrowserBase_IsReputationCheckingRequired", 0),
		/*95*/ imports.NewTable("WVBrowserBase_IsSuspended", 0),
		/*96*/ imports.NewTable("WVBrowserBase_IsSwipeNavigationEnabled", 0),
		/*97*/ imports.NewTable("WVBrowserBase_IsVisible", 0),
		/*98*/ imports.NewTable("WVBrowserBase_KeyboardShortcutRefreshIgnoreCache", 0),
		/*99*/ imports.NewTable("WVBrowserBase_KeyboardShortcutSearch", 0),
		/*100*/ imports.NewTable("WVBrowserBase_Language", 0),
		/*101*/ imports.NewTable("WVBrowserBase_MemoryUsageTargetLevel", 0),
		/*102*/ imports.NewTable("WVBrowserBase_MoveFormBy", 0),
		/*103*/ imports.NewTable("WVBrowserBase_MoveFormTo", 0),
		/*104*/ imports.NewTable("WVBrowserBase_Navigate", 0),
		/*105*/ imports.NewTable("WVBrowserBase_NavigateToString", 0),
		/*106*/ imports.NewTable("WVBrowserBase_NavigateWithWebResourceRequest", 0),
		/*107*/ imports.NewTable("WVBrowserBase_NotifyParentWindowPositionChanged", 0),
		/*108*/ imports.NewTable("WVBrowserBase_Offline", 0),
		/*109*/ imports.NewTable("WVBrowserBase_OpenDefaultDownloadDialog", 0),
		/*110*/ imports.NewTable("WVBrowserBase_OpenDevToolsWindow", 0),
		/*111*/ imports.NewTable("WVBrowserBase_OpenTaskManagerWindow", 0),
		/*112*/ imports.NewTable("WVBrowserBase_ParentWindow", 0),
		/*113*/ imports.NewTable("WVBrowserBase_PostSharedBufferToScript", 0),
		/*114*/ imports.NewTable("WVBrowserBase_PostWebMessageAsJson", 0),
		/*115*/ imports.NewTable("WVBrowserBase_PostWebMessageAsString", 0),
		/*116*/ imports.NewTable("WVBrowserBase_PreferredColorScheme", 0),
		/*117*/ imports.NewTable("WVBrowserBase_PreferredTrackingPreventionLevel", 0),
		/*118*/ imports.NewTable("WVBrowserBase_Print", 0),
		/*119*/ imports.NewTable("WVBrowserBase_PrintToPdf", 0),
		/*120*/ imports.NewTable("WVBrowserBase_PrintToPdfStream", 0),
		/*121*/ imports.NewTable("WVBrowserBase_ProcessInfos", 0),
		/*122*/ imports.NewTable("WVBrowserBase_Profile", 0),
		/*123*/ imports.NewTable("WVBrowserBase_ProfileCookieManager", 0),
		/*124*/ imports.NewTable("WVBrowserBase_ProfileIsGeneralAutofillEnabled", 0),
		/*125*/ imports.NewTable("WVBrowserBase_ProfileIsPasswordAutosaveEnabled", 0),
		/*126*/ imports.NewTable("WVBrowserBase_ProfileName", 0),
		/*127*/ imports.NewTable("WVBrowserBase_ProfilePath", 0),
		/*128*/ imports.NewTable("WVBrowserBase_RasterizationScale", 0),
		/*129*/ imports.NewTable("WVBrowserBase_Refresh", 0),
		/*130*/ imports.NewTable("WVBrowserBase_RefreshIgnoreCache", 0),
		/*131*/ imports.NewTable("WVBrowserBase_RemoveHostObjectFromScript", 0),
		/*132*/ imports.NewTable("WVBrowserBase_RemoveScriptToExecuteOnDocumentCreated", 0),
		/*133*/ imports.NewTable("WVBrowserBase_RemoveWebResourceRequestedFilter", 0),
		/*134*/ imports.NewTable("WVBrowserBase_RenderCompHWND", 0),
		/*135*/ imports.NewTable("WVBrowserBase_ResetZoom", 0),
		/*136*/ imports.NewTable("WVBrowserBase_ResizeFormHeightTo", 0),
		/*137*/ imports.NewTable("WVBrowserBase_ResizeFormWidthTo", 0),
		/*138*/ imports.NewTable("WVBrowserBase_Resume", 0),
		/*139*/ imports.NewTable("WVBrowserBase_RetrieveHTML", 0),
		/*140*/ imports.NewTable("WVBrowserBase_RetrieveMHTML", 0),
		/*141*/ imports.NewTable("WVBrowserBase_RetrieveText", 0),
		/*142*/ imports.NewTable("WVBrowserBase_RootVisualTarget", 0),
		/*143*/ imports.NewTable("WVBrowserBase_ScreenScale", 0),
		/*144*/ imports.NewTable("WVBrowserBase_ScriptEnabled", 0),
		/*145*/ imports.NewTable("WVBrowserBase_ScriptLocale", 0),
		/*146*/ imports.NewTable("WVBrowserBase_SendMouseInput", 0),
		/*147*/ imports.NewTable("WVBrowserBase_SendPointerInput", 0),
		/*148*/ imports.NewTable("WVBrowserBase_SetBoundsAndZoomFactor", 0),
		/*149*/ imports.NewTable("WVBrowserBase_SetFocus", 0),
		/*150*/ imports.NewTable("WVBrowserBase_SetFormLeftTo", 0),
		/*151*/ imports.NewTable("WVBrowserBase_SetFormTopTo", 0),
		/*152*/ imports.NewTable("WVBrowserBase_SetOnAcceleratorKeyPressed", 0),
		/*153*/ imports.NewTable("WVBrowserBase_SetOnAddScriptToExecuteOnDocumentCreatedCompleted", 0),
		/*154*/ imports.NewTable("WVBrowserBase_SetOnAfterCreated", 0),
		/*155*/ imports.NewTable("WVBrowserBase_SetOnBasicAuthenticationRequested", 0),
		/*156*/ imports.NewTable("WVBrowserBase_SetOnBrowserExtensionEnableCompleted", 0),
		/*157*/ imports.NewTable("WVBrowserBase_SetOnBrowserExtensionRemoveCompleted", 0),
		/*158*/ imports.NewTable("WVBrowserBase_SetOnBrowserProcessExited", 0),
		/*159*/ imports.NewTable("WVBrowserBase_SetOnBytesReceivedChanged", 0),
		/*160*/ imports.NewTable("WVBrowserBase_SetOnCallDevToolsProtocolMethodCompleted", 0),
		/*161*/ imports.NewTable("WVBrowserBase_SetOnCapturePreviewCompleted", 0),
		/*162*/ imports.NewTable("WVBrowserBase_SetOnClearBrowsingDataCompleted", 0),
		/*163*/ imports.NewTable("WVBrowserBase_SetOnClearCacheCompleted", 0),
		/*164*/ imports.NewTable("WVBrowserBase_SetOnClearDataForOriginCompleted", 0),
		/*165*/ imports.NewTable("WVBrowserBase_SetOnClientCertificateRequested", 0),
		/*166*/ imports.NewTable("WVBrowserBase_SetOnCompositionControllerCompleted", 0),
		/*167*/ imports.NewTable("WVBrowserBase_SetOnContainsFullScreenElementChanged", 0),
		/*168*/ imports.NewTable("WVBrowserBase_SetOnContentLoading", 0),
		/*169*/ imports.NewTable("WVBrowserBase_SetOnContextMenuRequested", 0),
		/*170*/ imports.NewTable("WVBrowserBase_SetOnControllerCompleted", 0),
		/*171*/ imports.NewTable("WVBrowserBase_SetOnCursorChanged", 0),
		/*172*/ imports.NewTable("WVBrowserBase_SetOnCustomItemSelected", 0),
		/*173*/ imports.NewTable("WVBrowserBase_SetOnD3DWindowCompMsg", 0),
		/*174*/ imports.NewTable("WVBrowserBase_SetOnDOMContentLoaded", 0),
		/*175*/ imports.NewTable("WVBrowserBase_SetOnDevToolsProtocolEventReceived", 0),
		/*176*/ imports.NewTable("WVBrowserBase_SetOnDocumentTitleChanged", 0),
		/*177*/ imports.NewTable("WVBrowserBase_SetOnDownloadStarting", 0),
		/*178*/ imports.NewTable("WVBrowserBase_SetOnDownloadStateChanged", 0),
		/*179*/ imports.NewTable("WVBrowserBase_SetOnEnvironmentCompleted", 0),
		/*180*/ imports.NewTable("WVBrowserBase_SetOnEstimatedEndTimeChanged", 0),
		/*181*/ imports.NewTable("WVBrowserBase_SetOnExecuteScriptCompleted", 0),
		/*182*/ imports.NewTable("WVBrowserBase_SetOnExecuteScriptWithResultCompleted", 0),
		/*183*/ imports.NewTable("WVBrowserBase_SetOnFaviconChanged", 0),
		/*184*/ imports.NewTable("WVBrowserBase_SetOnFrameContentLoading", 0),
		/*185*/ imports.NewTable("WVBrowserBase_SetOnFrameCreated", 0),
		/*186*/ imports.NewTable("WVBrowserBase_SetOnFrameDOMContentLoaded", 0),
		/*187*/ imports.NewTable("WVBrowserBase_SetOnFrameDestroyed", 0),
		/*188*/ imports.NewTable("WVBrowserBase_SetOnFrameNameChanged", 0),
		/*189*/ imports.NewTable("WVBrowserBase_SetOnFrameNavigationCompleted", 0),
		/*190*/ imports.NewTable("WVBrowserBase_SetOnFrameNavigationCompleted2", 0),
		/*191*/ imports.NewTable("WVBrowserBase_SetOnFrameNavigationStarting", 0),
		/*192*/ imports.NewTable("WVBrowserBase_SetOnFrameNavigationStarting2", 0),
		/*193*/ imports.NewTable("WVBrowserBase_SetOnFramePermissionRequested", 0),
		/*194*/ imports.NewTable("WVBrowserBase_SetOnFrameWebMessageReceived", 0),
		/*195*/ imports.NewTable("WVBrowserBase_SetOnGetCookiesCompleted", 0),
		/*196*/ imports.NewTable("WVBrowserBase_SetOnGetCustomSchemes", 0),
		/*197*/ imports.NewTable("WVBrowserBase_SetOnGetFaviconCompleted", 0),
		/*198*/ imports.NewTable("WVBrowserBase_SetOnGetNonDefaultPermissionSettingsCompleted", 0),
		/*199*/ imports.NewTable("WVBrowserBase_SetOnGetProcessExtendedInfosCompleted", 0),
		/*200*/ imports.NewTable("WVBrowserBase_SetOnGotFocus", 0),
		/*201*/ imports.NewTable("WVBrowserBase_SetOnHistoryChanged", 0),
		/*202*/ imports.NewTable("WVBrowserBase_SetOnIgnoreCertificateErrorsCompleted", 0),
		/*203*/ imports.NewTable("WVBrowserBase_SetOnInitializationError", 0),
		/*204*/ imports.NewTable("WVBrowserBase_SetOnIsDefaultDownloadDialogOpenChanged", 0),
		/*205*/ imports.NewTable("WVBrowserBase_SetOnIsDocumentPlayingAudioChanged", 0),
		/*206*/ imports.NewTable("WVBrowserBase_SetOnIsMutedChanged", 0),
		/*207*/ imports.NewTable("WVBrowserBase_SetOnLaunchingExternalUriScheme", 0),
		/*208*/ imports.NewTable("WVBrowserBase_SetOnLostFocus", 0),
		/*209*/ imports.NewTable("WVBrowserBase_SetOnMoveFocusRequested", 0),
		/*210*/ imports.NewTable("WVBrowserBase_SetOnNavigationCompleted", 0),
		/*211*/ imports.NewTable("WVBrowserBase_SetOnNavigationStarting", 0),
		/*212*/ imports.NewTable("WVBrowserBase_SetOnNewWindowRequested", 0),
		/*213*/ imports.NewTable("WVBrowserBase_SetOnOfflineCompleted", 0),
		/*214*/ imports.NewTable("WVBrowserBase_SetOnPermissionRequested", 0),
		/*215*/ imports.NewTable("WVBrowserBase_SetOnPrintCompleted", 0),
		/*216*/ imports.NewTable("WVBrowserBase_SetOnPrintToPdfCompleted", 0),
		/*217*/ imports.NewTable("WVBrowserBase_SetOnPrintToPdfStreamCompleted", 0),
		/*218*/ imports.NewTable("WVBrowserBase_SetOnProcessFailed", 0),
		/*219*/ imports.NewTable("WVBrowserBase_SetOnProcessInfosChanged", 0),
		/*220*/ imports.NewTable("WVBrowserBase_SetOnProfileAddBrowserExtensionCompleted", 0),
		/*221*/ imports.NewTable("WVBrowserBase_SetOnProfileDeleted", 0),
		/*222*/ imports.NewTable("WVBrowserBase_SetOnProfileGetBrowserExtensionsCompleted", 0),
		/*223*/ imports.NewTable("WVBrowserBase_SetOnRasterizationScaleChanged", 0),
		/*224*/ imports.NewTable("WVBrowserBase_SetOnRefreshIgnoreCacheCompleted", 0),
		/*225*/ imports.NewTable("WVBrowserBase_SetOnRenderCompMsg", 0),
		/*226*/ imports.NewTable("WVBrowserBase_SetOnRetrieveHTMLCompleted", 0),
		/*227*/ imports.NewTable("WVBrowserBase_SetOnRetrieveMHTMLCompleted", 0),
		/*228*/ imports.NewTable("WVBrowserBase_SetOnRetrieveTextCompleted", 0),
		/*229*/ imports.NewTable("WVBrowserBase_SetOnScriptDialogOpening", 0),
		/*230*/ imports.NewTable("WVBrowserBase_SetOnServerCertificateErrorActionsCompleted", 0),
		/*231*/ imports.NewTable("WVBrowserBase_SetOnServerCertificateErrorDetected", 0),
		/*232*/ imports.NewTable("WVBrowserBase_SetOnSetPermissionStateCompleted", 0),
		/*233*/ imports.NewTable("WVBrowserBase_SetOnSimulateKeyEventCompleted", 0),
		/*234*/ imports.NewTable("WVBrowserBase_SetOnSourceChanged", 0),
		/*235*/ imports.NewTable("WVBrowserBase_SetOnStatusBarTextChanged", 0),
		/*236*/ imports.NewTable("WVBrowserBase_SetOnTrySuspendCompleted", 0),
		/*237*/ imports.NewTable("WVBrowserBase_SetOnWebMessageReceived", 0),
		/*238*/ imports.NewTable("WVBrowserBase_SetOnWebResourceRequested", 0),
		/*239*/ imports.NewTable("WVBrowserBase_SetOnWebResourceResponseReceived", 0),
		/*240*/ imports.NewTable("WVBrowserBase_SetOnWebResourceResponseViewGetContentCompleted", 0),
		/*241*/ imports.NewTable("WVBrowserBase_SetOnWidget0CompMsg", 0),
		/*242*/ imports.NewTable("WVBrowserBase_SetOnWidget1CompMsg", 0),
		/*243*/ imports.NewTable("WVBrowserBase_SetOnWindowCloseRequested", 0),
		/*244*/ imports.NewTable("WVBrowserBase_SetOnZoomFactorChanged", 0),
		/*245*/ imports.NewTable("WVBrowserBase_SetPermissionState", 0),
		/*246*/ imports.NewTable("WVBrowserBase_SetVirtualHostNameToFolderMapping", 0),
		/*247*/ imports.NewTable("WVBrowserBase_ShouldDetectMonitorScaleChanges", 0),
		/*248*/ imports.NewTable("WVBrowserBase_ShowPrintUI", 0),
		/*249*/ imports.NewTable("WVBrowserBase_SimulateEditingCommand", 0),
		/*250*/ imports.NewTable("WVBrowserBase_SimulateKeyEvent", 0),
		/*251*/ imports.NewTable("WVBrowserBase_Source", 0),
		/*252*/ imports.NewTable("WVBrowserBase_StatusBarEnabled", 0),
		/*253*/ imports.NewTable("WVBrowserBase_StatusBarText", 0),
		/*254*/ imports.NewTable("WVBrowserBase_Stop", 0),
		/*255*/ imports.NewTable("WVBrowserBase_SubscribeToDevToolsProtocolEvent", 0),
		/*256*/ imports.NewTable("WVBrowserBase_SystemCursorID", 0),
		/*257*/ imports.NewTable("WVBrowserBase_TargetCompatibleBrowserVersion", 0),
		/*258*/ imports.NewTable("WVBrowserBase_ToggleMuteState", 0),
		/*259*/ imports.NewTable("WVBrowserBase_TrySuspend", 0),
		/*260*/ imports.NewTable("WVBrowserBase_UserAgent", 0),
		/*261*/ imports.NewTable("WVBrowserBase_UserDataFolder", 0),
		/*262*/ imports.NewTable("WVBrowserBase_WebMessageEnabled", 0),
		/*263*/ imports.NewTable("WVBrowserBase_Widget0CompHWND", 0),
		/*264*/ imports.NewTable("WVBrowserBase_Widget1CompHWND", 0),
		/*265*/ imports.NewTable("WVBrowserBase_ZoomControlEnabled", 0),
		/*266*/ imports.NewTable("WVBrowserBase_ZoomFactor", 0),
		/*267*/ imports.NewTable("WVBrowserBase_ZoomPct", 0),
		/*268*/ imports.NewTable("WVBrowserBase_ZoomStep", 0),
	}
)

func wVBrowserBaseImportAPI() *imports.Imports {
	if wVBrowserBaseImport == nil {
		wVBrowserBaseImport = NewDefaultImports()
		wVBrowserBaseImport.SetImportTable(wVBrowserBaseImportTables)
		wVBrowserBaseImportTables = nil
	}
