...
func NewCoreWebView2SharedBuffer(aBaseIntf ICoreWebView2SharedBuffer) ICoreWebView2SharedBuffer {
	r1 := coreWebView2SharedBufferImportAPI().SysCallN(3, GetObjectUintptr(aBaseIntf))
	return AsCoreWebView2SharedBuffer(r1)
}

func (m *TCoreWebView2SharedBuffer) Initialized() bool {
	r1 := coreWebView2SharedBufferImportAPI().SysCallN(5, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2SharedBuffer) BaseIntf() ICoreWebView2SharedBuffer {
	var resultCoreWebView2SharedBuffer uintptr
	coreWebView2SharedBufferImportAPI().SysCallN(0, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2SharedBuffer)))
	return AsCoreWebView2SharedBuffer(resultCoreWebView2SharedBuffer)
}

func (m *TCoreWebView2SharedBuffer) Size() (resultInt64 int64) {
	coreWebView2SharedBufferImportAPI().SysCallN(7, m.Instance(), uintptr(unsafePointer(&resultInt64)))
	return
}

func (m *TCoreWebView2SharedBuffer) Buffer() PByte {
	r1 := coreWebView2SharedBufferImportAPI().SysCallN(1, m.Instance())
	return PByte(r1)
}

func (m *TCoreWebView2SharedBuffer) OpenStream() IStream {
	var resultStream uintptr
	coreWebView2SharedBufferImportAPI().SysCallN(6, m.Instance(), uintptr(unsafePointer(&resultStream)))
	return AsStream(resultStream)
}

func (m *TCoreWebView2SharedBuffer) FileMappingHandle() HANDLE {
	r1 := coreWebView2SharedBufferImportAPI().SysCallN(4, m.Instance())
	return HANDLE(r1)
}

func (m *TCoreWebView2SharedBuffer) Close() bool {
	r1 := coreWebView2SharedBufferImportAPI().SysCallN(2, m.Instance())
	return GoBool(r1)
}

var (
	coreWebView2SharedBufferImport       *imports.Imports = nil
	coreWebView2SharedBufferImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2SharedBuffer_BaseIntf", 0),
		/*1*/ imports.NewTable("CoreWebView2SharedBuffer_Buffer", 0),
		/*2*/ imports.NewTable("CoreWebView2SharedBuffer_Close", 0),
		/*3*/ imports.NewTable("CoreWebView2SharedBuffer_Create", 0),
		/*4*/ imports.NewTable("CoreWebView2SharedBuffer_FileMappingHandle", 0),
		/*5*/ imports.NewTable("CoreWebView2SharedBuffer_Initialized", 0),
		/*6*/ imports.NewTable("CoreWebView2SharedBuffer_OpenStream", 0),
		/*7*/ imports.NewTable("CoreWebView2SharedBuffer_Size", 0),
	}
)

func coreWebView2SharedBufferImportAPI() *imports.Imports {
	if coreWebView2SharedBufferImport == nil {
		coreWebView2SharedBufferImport = NewDefaultImports()
		coreWebView2SharedBufferImport.SetImportTable(coreWebView2SharedBufferImportTables)
		coreWebView2SharedBufferImportTables = nil
	}
