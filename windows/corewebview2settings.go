...
func NewCoreWebView2Settings(aBaseIntf ICoreWebView2Settings) ICoreWebView2Settings {
	r1 := coreWebView2SettingsImportAPI().SysCallN(6, GetObjectUintptr(aBaseIntf))
	return AsCoreWebView2Settings(r1)
}

func (m *TCoreWebView2Settings) Initialized() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(8, m.Instance())
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) BaseIntf() ICoreWebView2Settings {
	var resultCoreWebView2Settings uintptr
	coreWebView2SettingsImportAPI().SysCallN(5, m.Instance(), uintptr(unsafePointer(&resultCoreWebView2Settings)))
	return AsCoreWebView2Settings(resultCoreWebView2Settings)
}

func (m *TCoreWebView2Settings) IsBuiltInErrorPageEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(9, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsBuiltInErrorPageEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(9, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) AreDefaultContextMenusEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(1, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetAreDefaultContextMenusEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(1, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) AreDefaultScriptDialogsEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(2, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetAreDefaultScriptDialogsEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(2, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) AreDevToolsEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(3, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetAreDevToolsEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(3, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsScriptEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(14, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsScriptEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(14, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsStatusBarEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(15, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsStatusBarEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(15, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsWebMessageEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(17, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsWebMessageEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(17, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsZoomControlEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(18, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsZoomControlEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(18, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) AreHostObjectsAllowed() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(4, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetAreHostObjectsAllowed(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(4, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) UserAgent() string {
	r1 := coreWebView2SettingsImportAPI().SysCallN(19, 0, m.Instance(), 0)
	return GoStr(r1)
}

func (m *TCoreWebView2Settings) SetUserAgent(AValue string) {
	coreWebView2SettingsImportAPI().SysCallN(19, 1, m.Instance(), PascalStr(AValue))
}

func (m *TCoreWebView2Settings) AreBrowserAcceleratorKeysEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(0, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetAreBrowserAcceleratorKeysEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(0, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsPasswordAutosaveEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(11, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsPasswordAutosaveEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(11, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsGeneralAutofillEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(10, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsGeneralAutofillEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(10, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsPinchZoomEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(12, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsPinchZoomEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(12, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) IsSwipeNavigationEnabled() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(16, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsSwipeNavigationEnabled(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(16, 1, m.Instance(), PascalBool(AValue))
}

func (m *TCoreWebView2Settings) HiddenPdfToolbarItems() TWVPDFToolbarItems {
	r1 := coreWebView2SettingsImportAPI().SysCallN(7, 0, m.Instance(), 0)
	return TWVPDFToolbarItems(r1)
}

func (m *TCoreWebView2Settings) SetHiddenPdfToolbarItems(AValue TWVPDFToolbarItems) {
	coreWebView2SettingsImportAPI().SysCallN(7, 1, m.Instance(), uintptr(AValue))
}

func (m *TCoreWebView2Settings) IsReputationCheckingRequired() bool {
	r1 := coreWebView2SettingsImportAPI().SysCallN(13, 0, m.Instance(), 0)
	return GoBool(r1)
}

func (m *TCoreWebView2Settings) SetIsReputationCheckingRequired(AValue bool) {
	coreWebView2SettingsImportAPI().SysCallN(13, 1, m.Instance(), PascalBool(AValue))
}

var (
	coreWebView2SettingsImport       *imports.Imports = nil
	coreWebView2SettingsImportTables                  = []*imports.Table{
		/*0*/ imports.NewTable("CoreWebView2Settings_AreBrowserAcceleratorKeysEnabled", 0),
		/*1*/ imports.NewTable("CoreWebView2Settings_AreDefaultContextMenusEnabled", 0),
		/*2*/ imports.NewTable("CoreWebView2Settings_AreDefaultScriptDialogsEnabled", 0),
		/*3*/ imports.NewTable("CoreWebView2Settings_AreDevToolsEnabled", 0),
		/*4*/ imports.NewTable("CoreWebView2Settings_AreHostObjectsAllowed", 0),
		/*5*/ imports.NewTable("CoreWebView2Settings_BaseIntf", 0),
		/*6*/ imports.NewTable("CoreWebView2Settings_Create", 0),
		/*7*/ imports.NewTable("CoreWebView2Settings_HiddenPdfToolbarItems", 0),
		/*8*/ imports.NewTable("CoreWebView2Settings_Initialized", 0),
		/*9*/ imports.NewTable("CoreWebView2Settings_IsBuiltInErrorPageEnabled", 0),
		/*10*/ imports.NewTable("CoreWebView2Settings_IsGeneralAutofillEnabled", 0),
		/*11*/ imports.NewTable("CoreWebView2Settings_IsPasswordAutosaveEnabled", 0),
		/*12*/ imports.NewTable("CoreWebView2Settings_IsPinchZoomEnabled", 0),
		/*13*/ imports.NewTable("CoreWebView2Settings_IsReputationCheckingRequired", 0),
		/*14*/ imports.NewTable("CoreWebView2Settings_IsScriptEnabled", 0),
		/*15*/ imports.NewTable("CoreWebView2Settings_IsStatusBarEnabled", 0),
		/*16*/ imports.NewTable("CoreWebView2Settings_IsSwipeNavigationEnabled", 0),
		/*17*/ imports.NewTable("CoreWebView2Settings_IsWebMessageEnabled", 0),
		/*18*/ imports.NewTable("CoreWebView2Settings_IsZoomControlEnabled", 0),
		/*19*/ imports.NewTable("CoreWebView2Settings_UserAgent", 0),
	}
)

func coreWebView2SettingsImportAPI() *imports.Imports {
	if coreWebView2SettingsImport == nil {
		coreWebView2SettingsImport = NewDefaultImports()
		coreWebView2SettingsImport.SetImportTable(coreWebView2SettingsImportTables)
		coreWebView2SettingsImportTables = nil
	}
